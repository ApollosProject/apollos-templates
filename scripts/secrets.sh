...
then
		...
		/usr/local/opt/openssl@1.1/bin/openssl enc -aes-256-cbc -pbkdf2 -iter 20000 -in apollos-church-api/.env.shared -out apolloschurchapp/.env.shared.enc -k "$2"
...
then
		...
		/usr/local/opt/openssl@1.1/bin/openssl enc -d -aes-256-cbc -pbkdf2 -iter 20000 -in apollos-church-api/.env.shared.enc -out apolloschurchapp/.env.shared -k "$2"
